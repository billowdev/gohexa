...
```bash
go run github.com/rapidstellar/gohexa/generators/repositories -generate repository -feature <FeatureName> -output <OutputDirectory> -project <ProjectName>
```

### Example Commands
Generate Repository File:
```bash
go run github.com/rapidstellar/gohexa/generators/repositories -generate repository -feature="Order" -output ./internal/adapters/repositories -project my_project
```
