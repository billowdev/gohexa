...
func main() {
	featureName := flag.String("feature", "", "The name of the feature to generate a handler for (e.g., Order)")
	outputDir := flag.String("output", "", "The output directory for the generated handler files")
	...
	generateHandlerFile(*outputDir, *featureName, *projectName)
}
